...
use culinograph_models::{NewHaccpMonitoringRecord, NewHaccpPlan, SaveHaccpPlanRequest};
use uuid::Uuid;
...
) -> Result<(StatusCode, Json<culinograph_models::HaccpPlanDocument>), ApiError> {
...
pub async fn get(
    ...
    State(state): State<ServiceState>,
) -> Result<Json<culinograph_models::HaccpPlanDocument>, ApiError> {
