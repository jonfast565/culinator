...
use culinograph_models::{NewRecipeTry, NewTryObservation, UpdateRecipeTry, UpdateTryOperation};
use uuid::Uuid;
...
) -> Result<Json<Vec<culinograph_models::RecipeTrySummary>>, ApiError> {
...
) -> Result<(StatusCode, Json<culinograph_models::RecipeTryDocument>), ApiError> {
...
pub async fn get(
    ...
    State(state): State<ServiceState>,
) -> Result<Json<culinograph_models::RecipeTryDocument>, ApiError> {
