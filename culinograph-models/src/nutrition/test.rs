...
use culinograph_core::{Dimension, Resource, ResourceKind, Value};
...
fn resource_mass_reads_quantity_property() {
    ...
    properties.insert(
        "quantity".to_owned(),
        Value::Quantity(culinograph_core::Quantity {
            value: 250.0,
            unit: "g".to_owned(),
    ...
    let resource = Resource {
        ...
        declared_type: culinograph_core::TypeRef::named("Ingredient"),
...
fn ingredient_resources_filters_kind() {
    let recipe = culinograph_core::Recipe {
        id: uuid::Uuid::new_v4(),
        book_id: None,
        symbol: "test".to_owned(),
        declared_type: culinograph_core::TypeRef::named("Recipe"),
        title: "Test".to_owned(),
        ...
        resources: vec![
            ...
            Resource {
                ...
                declared_type: culinograph_core::TypeRef::named("Container"),
