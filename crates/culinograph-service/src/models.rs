...
use culinograph_models::{ImportSettings, RecipeExportOptions, RecipeImage};
...
impl From<culinograph_application::RecipeSummary> for RecipeSummary {
    fn from(value: culinograph_application::RecipeSummary) -> Self {
        Self {
...
impl From<culinograph_application::RecipeDocument> for RecipeDocument {
    fn from(value: culinograph_application::RecipeDocument) -> Self {
        Self {
            id: value.id.to_string(),
            book_id: value.book_id.map(|id| id.to_string()),
            symbol: value.symbol,
...
impl From<culinograph_application::SourceDiagnostic> for Diagnostic {
    fn from(value: culinograph_application::SourceDiagnostic) -> Self {
        let severity = match value.severity {
            culinograph_application::DiagnosticSeverity::Error => "error",
            culinograph_application::DiagnosticSeverity::Warning => "warning",
            culinograph_application::DiagnosticSeverity::Information => "information",
        };
        Self {
            severity,
...
impl From<culinograph_application::RecipeOutline> for RecipeOutline {
    fn from(value: culinograph_application::RecipeOutline) -> Self {
        Self {
            title: value.title,
            symbol: value.symbol,
            protocol_version: value.protocol_version,
...
impl From<culinograph_application::RecipeBookSummary> for RecipeBookSummary {
    fn from(value: culinograph_application::RecipeBookSummary) -> Self {
        Self {
            id: value.id.to_string(),
            symbol: value.symbol,
            title: value.title,
