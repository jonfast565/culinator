...
<template>
  <div :key="miseLayout" class="index-card-deck" :data-format="format" :data-mise="miseLayout">
    <div v-for="page in pages" :key="`${miseLayout}-${page.index}`" class="index-card-frame">
      <article class="leaf index-card-leaf">
        ...
        <section v-if="page.methodBlocks.length" class="leaf-section method" :class="{ colocated }">
